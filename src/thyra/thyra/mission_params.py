...
class MissionParams:
    ...
    # ── Thresholds ──────────────────────────────────────────────────
    ground_err_thresh: float = 2.5   # SEARCH lock gate AND STABILIZE_HIGH lower bound
    search_kp:         float = 0.1   # P gain for STATIC SEARCH fly-toward
    ...
    gimbal_45_cmd:   float =  0.2   # servo value for 45° slant
